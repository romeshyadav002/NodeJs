...
app.use(
  ...
  //  so basically the function which send the res.send() is the route handler and other functions in the between are called `middlewares`
  // so basically middlewares are used for eg:- when you want to check the whether the user is authorized or not and you want to check before every call
);
